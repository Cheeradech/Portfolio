...
import brImage from './assets/DDD.png';
    ...
    <div className="dark">
      <div className="min-h-screen text-slate-200 overflow-x-clip selection:bg-primary selection:text-white relative antialiased">
        ...
        <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-0 overflow-hidden">
          <div className="absolute top-[-20%] left-[-10%] w-[80%] sm:w-[60%] h-[80%] sm:h-[60%] rounded-full" style={{ background: 'radial-gradient(circle, rgba(30,58,138,0.15) 0%, rgba(30,58,138,0) 70%)' }}></div>
          <div className="absolute bottom-[-10%] right-[-10%] w-[70%] sm:w-[50%] h-[70%] sm:h-[50%] rounded-full" style={{ background: 'radial-gradient(circle, rgba(124,45,18,0.15) 0%, rgba(124,45,18,0) 70%)' }}></div>
        </div>
