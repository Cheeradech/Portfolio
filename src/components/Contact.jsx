                            ...
                            <div className="space-y-5">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div className="space-y-2">
                                        ...
                                        <input type="text" className="w-full bg-[#050505] border border-white/5 rounded-2xl px-4 py-3.5 text-white text-sm focus:outline-none focus:border-blue-500/50 focus:bg-[#111114] transition-all duration-300 placeholder:text-slate-700" placeholder="John Doe" />
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input type="text" className="w-full bg-[#050505] border border-white/5 rounded-2xl px-4 py-3.5 text-white text-sm focus:outline-none focus:border-blue-500/50 focus:bg-[#111114] transition-all duration-300 placeholder:text-slate-700" placeholder="Reason for contact" />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-mono text-slate-500 uppercase tracking-[0.2em] ml-1">Message</label>
                                    <textarea rows="4" className="w-full bg-[#050505] border border-white/5 rounded-2xl px-4 py-3.5 text-white text-sm focus:outline-none focus:border-blue-500/50 focus:bg-[#111114] transition-all duration-300 resize-none placeholder:text-slate-700" placeholder="Write your message here..."></textarea>
                                </div>
                                <div className="pt-2">
                                    <button type="button" className="w-full py-4 bg-[#111114] hover:bg-[#1a1a20] border border-white/5 hover:border-white/10 text-white rounded-2xl transition-all duration-300 flex items-center justify-center gap-3 group/btn hover:shadow-[0_0_20px_rgba(59,130,246,0.15)]">
                                        <span className="text-[11px] font-mono tracking-[0.2em] uppercase font-bold text-slate-300 group-hover/btn:text-white transition-colors">Send Message</span>
