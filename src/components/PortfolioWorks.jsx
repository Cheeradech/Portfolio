                ...
                <motion.div
                    ...
                    {workItems.map((item, i) => (
                        <motion.div
                            ...
                            className="group bg-background-dark border border-white/5 overflow-hidden relative will-change-transform">
                            <div className="aspect-video w-full overflow-hidden bg-slate-900 relative">
                                <img
                                    alt={item.alt}
                                    className="w-full h-full object-cover opacity-60 group-hover:opacity-40 group-hover:scale-105 transition-all duration-700 will-change-transform"
                                    src={item.img}
                                    loading="lazy"
                                    decoding="async"
                                />
                            ...
                            <div className="p-8 absolute bottom-0 left-0 w-full pointer-events-none">
